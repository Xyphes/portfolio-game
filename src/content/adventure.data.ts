...
const adventureWorldCandidate = {
  ...
  canvasCopy: {
    ...
    tutorialEnemy: { fr: 'Cible d’entraînement', en: 'Training target' },
    tutorialRequired: {
      fr: 'Attaquez la cible avec le bouton d’action avant d’explorer.',
      en: 'Attack the target with the action button before exploring.',
    },
    tutorialComplete: {
  ...
  screens: [
    {
      ...
      hint: {
        fr: 'Approchez la cible puis attaquez une fois avec le bouton d’action.',
        en: 'Walk near the target, then attack once with the action button.',
      },
      exits: {
        up: 'study-ruins',
        down: 'personal-trail',
    ...
    },
    {
      ...
      hint: {
        fr: 'Épilogue facultatif : découvrez un intérêt pour obtenir le fragment, ou explorez les sept souvenirs.',
        en: 'Optional epilogue: discover one interest to collect the fragment, or explore all seven memories.',
      },
      exits: { up: 'training-clearing' },
      contentRefs: [
        { kind: 'interest', id: 'climbing' },
        { kind: 'interest', id: 'leathercraft' },
        { kind: 'interest', id: 'jewelry' },
        { kind: 'interest', id: 'woodworking' },
        { kind: 'interest', id: 'lockpicking' },
