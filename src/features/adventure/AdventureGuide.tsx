...
const copy = {
  fr: {
    ...
    steps: [
      ...
      ['2', 'Découvrez un récit', 'Approchez-vous d’un livre ou d’un personnage, puis utilisez l’action pour consulter une expérience, une étude ou un projet.'],
      ['3', 'Suivez la balise verte', 'Après un premier récit, la balise de la zone s’active. Rejoignez-la et utilisez de nouveau l’action pour obtenir le fragment.'],
      ['4', 'Concluez ou prolongez', 'Trois fragments terminent le parcours professionnel. La voie personnelle est un épilogue entièrement facultatif.'],
    ],
    controls: 'Commandes',
    move: 'Se déplacer',
  ...
  en: {
    ...
    steps: [
      ...
      ['2', 'Discover a story', 'Walk near a book or character, then use the action control to read about an experience, education, or project.'],
      ['3', 'Follow the green beacon', 'After your first story, the area beacon activates. Reach it and use the action control again to collect the fragment.'],
      ['4', 'Conclude or continue', 'Three fragments complete the professional journey. The personal path is an entirely optional epilogue.'],
    ],
    controls: 'Controls',
    move: 'Move',
