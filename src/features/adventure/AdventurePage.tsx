...
const copy = {
  ...
  en: {
    ...
    professionalText: 'The three professional fragments are reunited. My full profile, resume, and contact details are now directly available without exploring the personal trail.',
